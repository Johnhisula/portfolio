...
define('CERTIFICATES', [
    ...
    [
        'id'         => 'cert-8',
        'title'      => 'Certificate of Participation – Capstone Project Exhibit 2026',
        'issuer'     => 'Davao Del Norte State College – Institute of Computing',
        'date'       => 'June 1, 2026',
        'expires'    => null,
        'credential' => null,
        'image_path' => ASSETS_PATH . '/images/certs/cert-capstone-exhibit.png',
        'color'      => '#9333ea',
        'icon'       => 'bi-award-fill',
        'tags'       => ['Capstone Exhibit', 'AidLens', 'BSIT', 'DNSC'],
    ],
    [
        'id'         => 'cert-9',
        'title'      => 'Certificate of Appreciation – Research Project Presentation',
        'issuer'     => 'Davao Del Norte State College – Institute of Computing',
        'date'       => 'May 30, 2025',
        'expires'    => null,
        'credential' => null,
        'image_path' => ASSETS_PATH . '/images/certs/cert-precision-agriculture.jpg',
        'color'      => '#059669',
